...
def plot_horizontal_cross_sections(ply_file_path, num_sections=4, smoothing_sigma=20):
    # Load the mesh
    mesh = o3d.io.read_triangle_mesh(ply_file_path)

    if mesh.is_empty():
        raise ValueError(f"Mesh {ply_file_path} is empty or could not be loaded.")
...
if __name__ == '__main__':
    ...
    plot_horizontal_cross_sections(ply_file_path, smoothing_sigma=5, num_sections=8)
